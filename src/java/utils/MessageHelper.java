...
public class MessageHelper {
    ...
    public static Message getClientMessage(InputStream inputStream, String type) throws org.json.simple.parser.ParseException, ParseException {
    ...
    public static JSONObject stringToJsonObject(String json) throws ParseException, org.json.simple.parser.ParseException {
